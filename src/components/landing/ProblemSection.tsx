    ...
    <section id="solusi" className="py-16 md:py-28 bg-white">
      <div className="max-w-6xl mx-auto px-6 md:px-8">
        <div className="grid md:grid-cols-2 gap-10 md:gap-16">
            ...
            <div className="space-y-4">
              {PROBLEMS.map((item) => (
                <div key={item} className="flex items-start gap-3">
                  ...
                  <p className="text-[15px] text-gray-600">{item}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          {/* Solution */}
          <div>
            <h3 className="text-[13px] font-semibold text-black uppercase tracking-wider mb-6">Dengan SPI Tracker</h3>
            <div className="space-y-4">
              {SOLUTIONS.map((item) => (
                <div key={item} className="flex items-start gap-3">
                  ...
                  <p className="text-[15px] text-gray-900 font-medium">{item}</p>
                </div>
              ))}
            </div>
          </div>
