      ...
      <div className="max-w-6xl mx-auto px-6 md:px-8">
        ...
        <div className="text-center max-w-4xl mx-auto mb-12">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link
              href="/login"
              className="group inline-flex items-center gap-2 px-6 py-3 bg-black text-white text-[15px] font-medium rounded-lg hover:bg-gray-800 transition-all"
            >
              Mulai Gratis
            ...
            <a
              href="#fitur"
              className="inline-flex items-center gap-2 px-6 py-3 bg-white text-gray-700 text-[15px] font-medium rounded-lg border border-gray-200 hover:border-gray-300 hover:bg-gray-50 transition-all"
            >
