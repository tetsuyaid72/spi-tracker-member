...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields with invalid credentials and submit the form (click the 'Masuk' submit button). Then observe the page for an authentication failure message and confirm the user is not logged in.
